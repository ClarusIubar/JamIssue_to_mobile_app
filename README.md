...
4. 필요 시 좌표 보정: [20260323_fix_hanbat_yurim_coordinates.sql](/D:/Code305/JamIssue/backend/sql/migrations/20260323_fix_hanbat_yurim_coordinates.sql)
...
PR을 올릴 때는 `sample/`의 정본 HTML/이미지와 생성 결과물이 함께 보존되는지 확인해야 합니다.
