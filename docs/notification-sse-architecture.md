...
- [backend/app/db_models.py](../backend/app/db_models.py)
- [backend/app/models.py](../backend/app/models.py)
- [backend/app/repository_normalized.py](../backend/app/repository_normalized.py)
- [backend/app/notification_broker.py](../backend/app/notification_broker.py)
...
- [src/store/notification-store.ts](../src/store/notification-store.ts)
- [src/api/client.ts](../src/api/client.ts)
- [src/App.tsx](../src/App.tsx)
- [src/components/GlobalNotificationCenter.tsx](../src/components/GlobalNotificationCenter.tsx)
